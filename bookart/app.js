...
app.config(function($routeProvider) {
	...
	app.controller('KartListCtrl', function($scope) {
	$scope.kart = [];
	...
	$scope.books = [
		{
			...
			details: "Linda, in her thirties begings to question the routine and predictability of her days. In everybodys eyes, she has a perfect life-happy marriage, children and a career. Yet what she feels is an eno..."
		},
		{
